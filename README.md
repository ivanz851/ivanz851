...
Интересуюсь backend-разработкой на C++ и Java и разработкой приложений для мобильных устройств на Java и Kotlin. 
\
Занимаюсь спортивным программированием с 8 класса. \
...
**Спортивное программирование:** \
    ...
    TopCoder (max. 1322): [_ivanz_](https://profiles.topcoder.com/_ivanz_) \
    \
    ...
    \
    Призер олимпиад: Технокубок, Высшая проба, Московская олимпиада школьников по программированию, Когнитивные технологии.
